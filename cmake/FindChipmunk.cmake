...
if(WIN32)
    set(CHIPMUNK_INCLUDE_HINTS
        ${CMAKE_BINARY_DIR}/${CHIPMUNK_PATH}/include ${CHIPMUNK_PATH}/include)
    set(CHIPMUNK_LIBRARY_HINTS
        ${CMAKE_BINARY_DIR}/${CHIPMUNK_PATH}/bin ${CHIPMUNK_PATH}/bin)
endif(WIN32)
